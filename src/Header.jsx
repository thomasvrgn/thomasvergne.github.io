...
export default function App() {
  return <header className="relative min-h-screen overflow-hidden flex items-center justify-center">
    ...
    {/* Bottom blur effect */}
    <div className="absolute -bottom-1/3 -left-1/3 -right-1/3 h-3/5 bg-white filter blur-[7rem]"></div>

    {/* Centered header container */}
    <div className="text-center z-10 children:bg-white children:mx-auto">
      ...
      <Button black withIcon='ArrowRight'>
