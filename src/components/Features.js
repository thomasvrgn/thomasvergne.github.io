...
export const Feature = ({ icon, children }) => {
  ...
  return <div className="flex flex-row items-start group dark:hover:bg-gray-900 dark:hover:bg-opacity-30 rounded-xl p-4 dark:transform hover:-translate-y-1 transition-all duration-500 hover:cursor-pointer dark:hover:shadow-lg">
    <div className="mr-4">
    ...
    <header>
      ...
      <p className="dark:text-white dark:text-opacity-50 dark:font-light text-gray-600 text-opacity-70 ">{subtitle.props.children}</p>
    </header>
  </div>
}